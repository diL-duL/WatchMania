                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: const Icon(Icons.movie_filter_rounded, size: 40, color: AppTheme.backgroundBlack),
                      ),
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      child: auth.isLoading
                                          ? const SizedBox(
                                              width: 24,
                                              height: 24,
                                              child: CircularProgressIndicator(strokeWidth: 2.5, color: AppTheme.backgroundBlack),
                                            )
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: const Text(
                              'Daftar',
                              style: TextStyle(color: AppTheme.primaryGold, fontSize: 14, fontWeight: FontWeight.w700),
                            ),
                          ),
                        ],
                      ),
