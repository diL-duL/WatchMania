    ...
    if (confirmed == true && context.mounted) {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              success ? 'Film berhasil dihapus!' : 'Gagal menghapus film',
            ),
      ...
      body: NestedScrollView(
          ...
          SliverAppBar(
            ...
            title: _isSearching
                ? TextField(
                    ...
                    onChanged: (v) =>
                        context.read<FilmController>().setSearchQuery(v),
                  )
                : Row(
                    children: [
                      Container(
        ...
        body: Consumer<FilmController>(
          builder: (context, ctrl, _) {
            ...
            if (ctrl.errorMessage != null && ctrl.films.isEmpty)
          ...
          ? ScaleTransition(
              ...
              child: FloatingActionButton(
                onPressed: () =>
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => const FilmFormView()),
                    ).then((_) {
                      if (context.mounted)
                        context.read<FilmController>().fetchFilms();
                    }),
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, i) => _GridCard(
        ...
        onTap: () =>
            Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => FilmDetailView(film: films[i])),
            ).then((_) {
              if (context.mounted) context.read<FilmController>().fetchFilms();
            }),
